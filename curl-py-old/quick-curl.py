...
for op,value in opts:
        if op=="-u":
                ...
                client=value
# curl_loader参数设置
f=open(r"/home/jinrongc/curl-py/curl_base.conf","r+")
flist=[]
flist=f.readlines()
print flist[0]
...
flist[14]='URL='+url+'\n'
f=open(r"/home/jinrongc/curl-py/curl_base.conf","w+")
f.writelines(flist)
...
print 'running...'
if location=="local":
	cmd = "/home/curl-loader-0.56/curl-loader -f /home/jinrongc/curl-py/curl_base.conf"
