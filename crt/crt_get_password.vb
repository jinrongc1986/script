...
Sub Main
	...
	crt.Screen.Send("curl -k -g 'https://192.168.1.232:5534/getadmin?sn="+sn+"'"+ chr(13))
	crt.Screen.WaitForString("[root@")
	crt.Screen.WaitForString("[root@")
	crt.Screen.Send(chr(13))
	screenrow = crt.screen.CurrentRow
	passwd=crt.Screen.Get(screenrow, 66, screenrow, 73 )
	crt.Screen.Send("echo "+passwd+chr(13))
